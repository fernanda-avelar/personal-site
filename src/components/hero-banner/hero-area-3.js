...
const data = {
  ...
  subtitle: "Frontend Engineer + UI designer",
  cta: "Download CV",
  ctaLink: "/assets/Fernanda_Avelar_Goncalves_CV.pdf",
}
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-6">
              ...
              >
                ...
                <a
                  href={'https://calendly.com/fernandacarneiroavelar1995/fernanda-avelar-call'}
                  target="_blank"
                  className="banner__btn btn gradient-btn gradient-btn-2 scroll-to-target"
                >
                ...
                <div className="banner__images-grid-two">
                  ...
                  >
                    <div className="main-image">
                      ...
                      <img src="/assets/img/artwork/eu.jpg" alt="artwork" />
                    </div>
                  </div>
                  ...
                  >
                    <div className="main-image">
                      <canvas width="272" height="272"></canvas>
                      <img src="/assets/img/artwork/eu.png" alt="artwork" />
                    </div>
                  </div>
                </div>
              </div>
